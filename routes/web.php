...
Route::post('/mercadopago/customer/create', [MercadoPagoTestController::class, 'createCustomer']);
Route::post('/mercadopago/card/save', [MercadoPagoTestController::class, 'saveCard']);
